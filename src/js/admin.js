...
window.cargarDatos = function(){
    let preLoad = [];
    let producto1 = new Producto ("01",   "Windbound", "Arcade, supervivencia y aventuras", `Las Islas Prohibidas te llaman; descubre sus secretos Naufragaste, estás en una isla 
    y debes descubrir, adaptarte y explorar para sobrevivir.`, `Tras naufragar en una isla, explora, adáptate y recorre la tierra y los mares para sobrevivir.
    ...
    Al explorar otras islas y las ruinas dispersas por la tierra, descubrirás secretos del pasado y atisbos del futuro. Desvela el misterio tras todas ellas y quizá encuentres algo más que el modo de volver a casa.`, "windbound-sm.png", "windbound-1.jpg", "windbound-2.jpg" , "https://www.youtube.com/embed/Gfcxpb5kTR8");
    preLoad.push(producto1);
    let producto2 = new Producto("02", 'Ark: survival evolved', "Arcade, supervivencia y aventuras", ` Varado a orillas de una isla misteriosa, debes aprender a sobrevivir. 
    Usa tu astucia para matar o domar a las criaturas primitivas que deambulan por el territorio, 
    ¡y encuentra a otros jugadores para sobrevivir, dominar y escapar!`, ` Varado a orillas de una isla misteriosa, debes aprender a sobrevivir. 
    Usa tu astucia para matar o domar a las criaturas primitivas que deambulan por el territorio, 
    ¡y encuentra a otros jugadores para sobrevivir, dominar y escapar!`, "ark-sm.png", "ark-1.jpg", "ark-2,jpg", "https://www.youtube.com/embed/5fIAPcVdZO8");
    preLoad.push(producto2);
    let producto3 = new Producto("03", "SpongeBob: Battle for Bikini Bottom", "Arcade, supervivencia y aventuras", ` ¿Están listos, chicos? El clásico de culto ha vuelto en su nueva versión.
    Juega como Bob Esponja, Patricio y Arenita para demostrarle 
    al malvado Plankton que ser un criminal es peor que trabajar para Don Cangrejo.`, `¿Estáis listos, chicos? ¡Vuelve un clásico de culto recreado con todo el esponjoso esplendor del original! Juega como Bob Esponja, Patricio y Arenita y demuéstrale a Plankton que el crimen paga aún menos que el Sr. Cangrejo. ¿Quieres salvar Fondo de Bikini de un montón de robots descontrolados con el poder de tus burbujas? ¡Claro que sí! ¿Quieres hacer puenting en ropa anterior? ¡¿Y quién no?! ¿Quieres unir fuerzas en un modo multijugador completamente nuevo? ¡Que comience la batalla!`, "bob-sm.png", "bob-1.png", "bob-2.jpg", "https://www.youtube.com/embed/q3sX703lW_w");
    preLoad.push(producto3);
    let producto4 = new Producto ("04", "Kena: Bridge of Spirits", "Arcade, supervivencia y aventuras", ` Una aventura narrativa y de acción que combina exploración con ágiles combates. 
    Los jugadores se ponen en la piel de Kena para encontrar encantadores compañeros espirituales llamados Rot, 
    sumarlos al equipo, mejorar sus habilidades y crear nuevas formas de manipular el entorno.`, `La historia
    ...
    `, "kena-sm.png", "kena-1.jpg", "kena-2.jpg", "https://www.youtube.com/embed/1aI_9mY7RgE");
    preLoad.push(producto4);
    let producto5 = new Producto("05", "Fortnite", "Arcade, supervivencia y aventuras", ` ¡Date un chapuzón de aventuras en la temporada 3 del capítulo 2! 
    Sobrevive a más que la tormenta en las secuelas de su venganza. 
    A medida que la isla se adapta a su inundada forma de vida, mantente a flote y enfréntate a enemigos y desafíos nuevos.`, `Capítulo 2 de Fortnite Luchad. Construid. Cread.
    Fortnite es el juego multijugador gratuito y en constante evolución en el que vosotros junto a vuestros amigos lucharéis para ser los últimos en pie o colaboraréis para crear un mundo de ensueño. Jugad a Battle Royale y al modo Creativo GRATIS. Descargadlo ya y lanzaos a la acción. La descarga también ofrece la opción de comprar la campaña JcE Salvar el mundo.`, "fortnite-sm.png", "fortnite-1.jpg", "fortnite-2.jpg", "https://www.youtube.com/embed/8A2W-mK6k-g")
    preLoad.push(producto5);
    let producto6 = new Producto("06", "The Last Campfire", "Arcade, supervivencia y aventuras", ` The Last Campfire es un juego de aventuras obra de Hello Games (No Man's Sky) y cuenta la historia de Ember que,
    atrapado en un lugar extraño, busca una motivación y una forma de volver a casa.`, `The Last Campfire es un juego de aventuras obra de Hello Games (No Man's Sky) y cuenta la historia de Ember que, atrapado en un lugar extraño, busca una motivación y una forma de volver a casa.`, "camp-sm.png", "camp-1.jpg", "camp-2.jpg", "https://www.youtube.com/embed/tBY6XUf3rxs");
    preLoad.push(producto6);
    let producto7 = new Producto("07", "SUPERHOT: Mind Control Delete", "Acción, supervivencia y guerra", `MIND CONTROL DELETE, creado sobre los cimientos de SUPERHOT y SUPERHOT VR,
    promete darte más de la emblemática fantasía de poder de SUPERHOT.`, `La avaricia no te hará libre. Pero aquí sigues. Quieres más. Muy bien. Sírvete. Sabes que esto no va a acabar bien. <br>
    ...
    Disparas y cortas. Avanzas. Y otra vez. Y otra vez. Y otra vez. Se vuelve un ritual. Empieza a cobrar significado de nuevo. El tercer juego de la franquicia SUPERHOT, MIND CONTROL DELETE, ofrece más información sobre el mundo de SUPERHOT, más historia y más jugabilidad. Sigue bailando el ballet de la destrucción a cámara lenta durante mucho más tiempo que nunca. <br>`, "mindcontrol-sm.png", "mindcontrol-1.jpg", "mindcontrol-2.jpg", "https://www.youtube.com/embed/rFAqvOASQrs");
    preLoad.push(producto7);
    let producto8 = new Producto("08", "Zombie Army 4: Dead War", "Acción, supervivencia y guerra", `¡Las hordas de Hitler regresan a por más en este aterrador juego de disparos de los creadores de Sniper 
    Elite 4! Abominables enemigos sobrenaturales, armas épicas y una horripilante nueva campaña de 1 a 4 
    jugadores te esperan en la Europa de los años 40. ¡Salva a la humanidad del apocalipsis zombi!`, `¡Las hordas de Hitler regresan a por más en este aterrador juego de disparos de los creadores de Sniper Elite 4! Abominables enemigos sobrenaturales, armas épicas y una horripilante nueva campaña de 1 a 4 jugadores te esperan en la Europa de los años 40. ¡Salva a la humanidad del apocalipsis zombi! <br>
    ...
    Disfruta de un sistema de balística que revolucionó el género y por el que se hizo famosa la franquicia Sniper Elite de Rebellion. ¡Dale un buen uso acabando con las hordas de condenados! <br>`, "zombie-sm.png", "zombie-1.jpg", "zombie-2.jpg", "https://www.youtube.com/embed/w5TbuuHdNzc");
    preLoad.push(producto8);
    let producto9 = new Producto("09","Chorus", "Acción, supervivencia y guerra", `Ponte en la piel de Nara, quien alguna vez fue la guerrera más letal del Círculo, pero ahora es la fugitiva más 
    buscada por ellos, y acompáñala en su misión para destruir el culto oscuro que la creó.`, `Ponte en la piel de Nara, una de las guerreras más mortíferas del Círculo y su fugitiva más buscada, en una misión para destruir la secta tenebrosa que la creó.`, "chorus-sm.png", "chorus-1.jpg", "chorus-2.jpg", "https://www.youtube.com/embed/2ItKZESXDLg");
    preLoad.push(producto9);
    let producto10 = new Producto("10", "Total War Saga: TROY", "Acción, supervivencia y guerra", ` En esta era legendaria, los héroes caminan por la tierra. En un acto que conmociona al mundo, el audaz Paris, 
    príncipe de Troya, huye con la bella reina de Esparta.
    Mientras zarpan, el rey Menelao la maldice. Jura recuperar a su esposa, ¡cueste lo que cueste!`, `Llega Total War Saga: TROY, un juego inspirado en la Ilíada, el extraordinario relato de amor y sangre de Homero. Esta entrega se centra en el punto álgido de la guerra de Troya y consigue revivir aquel conflicto histórico como nunca antes.`, "troy-sm.png", "troy-1.jpeg", "troy-2.jpg", "https://www.youtube.com/embed/4ZR3DGFwehw");
    preLoad.push(producto10);
    let producto11 = new Producto("11", "Death Stranding", "Acción, supervivencia y guerra", `Del legendario diseñador de videojuegos Hideo Kojima llega una experiencia completamente nueva que desafía los géneros.
    ...
    mundo paso a paso.`, `Del legendario diseñador de videojuegos Hideo Kojima llega una experiencia completamente nueva que desafía los géneros.
    Sam Bridges debe enfrentarse a un mundo completamente transformado por la muerte en DEATH STRANDING. 
    Con los restos aislados de nuestro futuro en sus manos, se embarca en un viaje para volver a unir el fragmentado 
    mundo paso a paso.`, "death-sm.png", "death-1.jpg", "death-2.jpg", "https://www.youtube.com/embed/Gu8X7vM3Avw" );
    preLoad.push(producto11);
    let producto12 = new Producto("12", "Rogue Company", "Acción, supervivencia y guerra", `El paquete de fundador estándar de Rogue Company da acceso anticipado al juego y todo lo que necesitas para luchar. 
    Consigue acceso a 8 mercenarios jugables extra, ¡además de 4 objetos estéticos para que hagas todas las 
    misiones con mucho estilo!`, `El paquete de fundador estándar de Rogue Company da acceso anticipado al juego y todo lo que necesitas para luchar. 
    Consigue acceso a 8 mercenarios jugables extra, ¡además de 4 objetos estéticos para que hagas todas las 
    misiones con mucho estilo!`, "rogue-sm.png", "rogue-1.jpg", "rogue-2.jpg", "https://www.youtube.com/embed/9THEZleh5x0");
    preLoad.push(producto12);
    let producto13 = new Producto("13", "Trackmania" , "Simulación", `Trackmania, la franquicia de carreras de Ubisoft Nadeo, regresa con el remake más emocionante de Trackmania Nations.`, `Trackmania, la franquicia de carreras de Ubisoft Nadeo, regresa con el remake más emocionante de Trackmania Nations.`, "trackmania-sm.png", "trackmania-1.png", "trackmania-2.png", "https://www.youtube.com/embed/TQQOwnbuvsc");
    preLoad.push(producto13);
    let producto14= new Producto("14", "Beyond Blue", "Simulación", `Beyond Blue es una aventura narrativa para un jugador que te lleva a las profundidades del corazón 
    azul que late en nuestro planeta.`, `Beyond Blue es una aventura narrativa para un jugador que te lleva a las profundidades del corazón 
    azul que late en nuestro planeta.`, "blue-sm.png", "blue-1.jpg", "blue-2.jpg", "https://www.youtube.com/embed/pOAWBCXpo6k");
    preLoad.push(producto14);
    let producto15 = new Producto("15", "SnowRunner", "Simulación", ` ¡Prepárate para la experiencia todoterreno de próxima generación! Conduce potentes vehículos y sobreponte a 
    entornos abiertos extremos para completar decenas de misiones desafiantes en solitario o con hasta 3 amigos.`, ` ¡Prepárate para la experiencia todoterreno de próxima generación! Conduce potentes vehículos y sobreponte a 
    entornos abiertos extremos para completar decenas de misiones desafiantes en solitario o con hasta 3 amigos.`, "snow-sm.png", "snow-1.jpg", "snow-2.jpg", "https://www.youtube.com/embed/hcFSFjJ2b6o");
    preLoad.push(producto15);
    let producto16 = new Producto("16", "Surgeon Simulator 2", "Simulación", ` El caos de la física vuelve con Surgeon Simulator 2, la delirante secuela del simulador de
    operaciones original. ¡Del modo Cooperativo de 4 jugadores al nuevo modo Creación de Bossa Labs, 
    explora una instalación médica increíble en esta secuela más sustanciosa! `, ` El caos de la física vuelve con Surgeon Simulator 2, la delirante secuela del simulador de
    operaciones original. ¡Del modo Cooperativo de 4 jugadores al nuevo modo Creación de Bossa Labs, 
    explora una instalación médica increíble en esta secuela más sustanciosa! `, "surgeon-sm.png", "surgeon-1.png", "surgeon-2.png", "https://www.youtube.com/embed/VFUwc-Pd5C4");
    preLoad.push(producto16);
    let producto17 = new Producto("17", "Ooblets", "Simulación", ` Ooblets es un juego de agricultura, recopilación de criaturas y vida rural en el que podrás 
    diseñar tu granja, entablar amistad con los aldeanos, cultivar ooblets y participar en competiciones de baile.`, ` Ooblets es un juego de agricultura, recopilación de criaturas y vida rural en el que podrás 
    diseñar tu granja, entablar amistad con los aldeanos, cultivar ooblets y participar en competiciones de baile.`, "ooblets-sm.png", "ooblets-1.jpg", "ooblets-2.jpg", "https://www.youtube.com/embed/OB6qo8wls0k");
    preLoad.push(producto17);
    let producto18 = new Producto("18", "Farming Simulator 19", "Simulación", `¡La simulación agrícola definitiva vuelve con una completa revisión gráfica y la experiencia agrícola
    ...
    y animales que cuidar.`, `¡La simulación agrícola definitiva vuelve con una completa revisión gráfica y la experiencia agrícola
    más completa de la historia! Conviértete en un moderno agricultor y desarrolla una granja en tres 
    enormes entornos de América y Europa repletos de emocionantes actividades agrícolas nuevas, cultivos que cosechar 
    y animales que cuidar.`, "farm-sm.png", "farm-1.jpg", "farm-2.jpg", "https://www.youtube.com/embed/3zJfrU5Njpc");
